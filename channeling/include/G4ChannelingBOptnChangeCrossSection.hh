...
//---------------------------------------------------------------
//
// G4ChannelingBOptnChangeCrossSection
//
// Class Description:
...
#ifndef G4ChannelingBOptnChangeCrossSection_hh
#define G4ChannelingBOptnChangeCrossSection_hh 1

#include "G4VBiasingOperation.hh"
class G4InteractionLawPhysical;

class G4ChannelingBOptnChangeCrossSection : public G4VBiasingOperation {
public:
    // -- Constructor :
    G4ChannelingBOptnChangeCrossSection(G4String name);
    // -- destructor:
    virtual ~G4ChannelingBOptnChangeCrossSection();
